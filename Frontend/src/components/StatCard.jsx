  ...
  return (
    <div className="bg-primary text-white flex flex-col justify-center items-center space-y-8 p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl">
        <StatCard title="LeetCode" endValue={324} duration={2000} />
        <StatCard title="GeeksforGeeks" endValue={117} duration={2000} />
        <StatCard title="Coding Ninja" endValue={46} duration={2000} />
      </div>
    </div>
  );
};
